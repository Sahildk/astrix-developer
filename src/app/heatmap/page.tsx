...
// Aggregate data logic preserved for Sidebar (kept as is)
const neighborhoodData = MOCK_ISSUES.reduce((acc, issue) => {
  ...
  return acc;
}, {} as Record<string, { count: number, severity: number, issues: typeof MOCK_ISSUES }>);
    ...
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      <div className="flex-col md:flex-row p-4 border-b border-white/10 flex justify-between items-start md:items-center bg-background/80 backdrop-blur gap-4 z-10 relative">
         <div>
            ...
            <p className="text-xs md:text-sm text-muted-foreground">Visualizing issue density across neighborhoods.</p>
         </div>
